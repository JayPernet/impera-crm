            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="p-6 rounded-xl border border-border bg-surface/30 backdrop-blur-xl shadow-xl shadow-primary/5 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <input {...form.register("address_zip")} className="w-full h-10 bg-surface-elevated border border-border-strong rounded-lg px-3 text-text-primary focus:outline-none focus:border-primary" placeholder="00000-000" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <input {...form.register("address_street")} className="w-full h-10 bg-surface-elevated border border-border-strong rounded-lg px-3 text-text-primary focus:outline-none focus:border-primary" />
                        </div>
                        <div className="space-y-2">
                ...
                <div className="p-6 rounded-xl border border-border bg-surface/30 backdrop-blur-xl shadow-xl shadow-primary/5 space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs text-text-secondary">Área Priv. (m²)</label>
                            <input {...form.register("area_m2")} className="w-full h-9 bg-surface-elevated border border-border-strong rounded-lg px-3 text-text-primary focus:outline-none focus:border-primary" />
                        </div>
                    </div>
                </div>
